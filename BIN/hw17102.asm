...
inloop:
	mov al ,[si] ; moves value of mem adress pointed by si into al 
	cmp [bx-1], al; compaers value of mem adress pointed by bx and al
	jnz cont ; if not equals jumps to count
	
	inc [count] ; increments the number of count every time array item is changed
